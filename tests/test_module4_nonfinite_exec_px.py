...
from weightiz.module4.strategy_funnel import Module4Config, run_module4_signal_funnel, run_module4_strategy_funnel
...
class TestModule4NonFiniteExecPx(unittest.TestCase):
    def test_execution_entry_is_forbidden_before_legacy_exec_price_handling(self) -> None:
        st = _mk_state()
    ...
    def test_signal_funnel_returns_frozen_signal_output_on_same_state(self) -> None:
        st = _mk_state()
