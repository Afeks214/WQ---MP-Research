        ...
        candidate_rows.append(
            {
                ...
                "module6_policy_class": str(verdict_row.get("module6_policy_class", "standard")),
                "module6_admit": bool(verdict_row.get("module6_admit", not bool(verdict_row.get("reject", False)))),
                "module6_admission_basis": str(verdict_row.get("module6_admission_basis", "")),
