...
from weightiz.module5.harness.artifact_writers import to_jsonable
from weightiz.module1.core import TensorState
...
def is_risk_constraint_breach(error_type: str, error_msg: str, top_frame: str, traceback_text: str = "") -> bool:
    ...
    if (
        ("weightiz_module1_core.py" in top_low or "src/weightiz/module1/core.py" in top_low)
        and ("_validate_portfolio_constraints" in top_low)
    ):
        return True
    risk_terms = (
        "leverage breach",
